...
class bio462_hw5_1(Homework):
    ...
    def __init__(self, student_id=None, version="latest", no_internet=False):
        ...
        data_files = {
            "1.0.0": [
                "bio462_hw5_1_ans.txt",
                "bio462_hw5_1_hint.txt"
            ],
        }

        # Call the parent class
        super().__init__(hw_number="bio462_hw5_1", student_id=student_id, version=version, valid_versions=valid_versions, data_files=data_files, no_internet=no_internet)
        ...
        for file_path in self._data_files_paths:
            ...
            if file_name == "bio462_hw5_1_ans.txt":
                self.ansArray = self.parseAnswers(file_path)
            elif file_name == "bio462_hw5_1_hint.txt":
